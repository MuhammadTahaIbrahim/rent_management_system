...
// Assuming user login has been implemented and the user's name and email are stored in the session
                        ...
                        <form class="contact-form-style padding-20-row-col" id="contact-form" method="post" onsubmit="return validateForm()">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-12">
                                    <input name="contact_name" id="contact_name" required type="text" placeholder="Name*" pattern="[a-zA-Z\s]+" title="Name should contain only letters and spaces" value="<?php echo htmlspecialchars($user_name); ?>">
                                </div>
