...
<div class="contact-us-area pb-135">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <input name="l_name" required type="text" placeholder="Name*">
        </div>
        <div class="col-lg-6 col-md-12 col-12">
            <input type="email" name="l_email" required placeholder="Email*">
        </div>
        <div class="col-lg-6 col-md-12 col-12">
            <input type="tel" name="l_phone" required placeholder="Phone*">
        </div>
        <div class="col-lg-12 col-md-12 col-12">
            <input type="file" name="l_img" accept="image/*" required class="form-control">
        </div>
        <div class="col-lg-12 col-md-12 col-12">
