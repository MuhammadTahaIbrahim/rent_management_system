    ...
    <?php foreach($_SESSION["cart"] as $key => $item): ?>
        <tr>
            <td class="product-thumbnail">
                <a href="uproduct-details.php"><img src="admin/images/<?php echo htmlspecialchars($item["Img"]); ?>" alt=""></a>
            </td>
            <td class="product-name">
                <h5><a href="uproduct-details.php"><?php echo htmlspecialchars($item["Name"]); ?></a></h5>
            </td>
            ...
            <td class="product-remove"><a href="uremove.php?rid=<?php echo $key; ?>"><i class="las la-trash"></i></a></td>
        </tr>
    <?php endforeach; ?>
</tbody>
                            ...
                            <div class="col-lg-12">
                                <div class="cart-shiping-update-wrapper">
                                    <div class="cart-shiping-update">
                                        <a href="uindex.php">Continue Shopping</a>
                                    </div>
                                    <div class="cart-clear">
                                        <!-- <button type="submit" name="update_cart">Update Cart</button> -->
                                        <a href="uclear.php">Clear Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
