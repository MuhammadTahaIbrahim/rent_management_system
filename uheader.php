                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-4">
                        <div class="logo text-center">
                            <a href="uindex.php"><img src="assets/images/logo/logod.png" alt="logo"></a>
                        </div>
                    </div>
                    <div class="col-4">
    ...
    <div class="sidebar-cart-all">
        ...
        <div class="cart-content">
                    ...
                    foreach ($_SESSION["cart"] as $key => $item) {
                        if (isset($item['ID'], $item['Name'], $item['Img'], $item['Price'], $item['Qty'])) {
                            ...
                            <li class="single-product-cart">
                                <div class="cart-img">
                                    <a href="uproduct-details.php"><img src="<?php echo $product_image; ?>" alt=""></a>
                                </div>
                                <div class="cart-title">
                                    <h4><a href="uproduct-details.php"><?php echo $product_name; ?></a></h4>
            ...
            <div class="btn-style cart-checkout-btn">
                <a class="btn btn-outline-primary" href="ucart.php">View cart</a>
                <a class="btn btn-outline-primary" href="ucheckout.php">Checkout</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="off-canvas-wrap">
                <div class="menu-wrap">
                    <div id="menu" class="slinky-mobile-menu text-left">
                        <ul>
                        <li>
                                <a href=""><?php echo "WELCOME, " . $_SESSION['logname'] ?></a>
                            ...
                            foreach ($categories as $cat_id => $category) {
                                echo "<li><a href='ushop.php?cid=$cat_id'>" . $category['cat_name'] . "</a><ul>";
                                foreach ($category['subcategories'] as $subcategory) {
                                    echo "<li><a href='ushop.php?scid=" . $subcategory['subid'] . "'>" . $subcategory['subname'] . "</a></li>";
                                }
                                echo "</ul></li>";
                            }
                            ?>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <!-- <li><a href="ublog-details.php">Blog Details</a></li> -->
                                </ul>
                            </li>
                            <li>
