...
<!-- <div class="slider-area">
    <div class="slider-active-1 nav-style-1">
        <div class="single-slider-wrap slider-height-1 d-flex align-items-center justify-content-center">
            <img src="assets/images/slider/home.jpg" alt="Slider Image" class="img-fluid">
        </div>
    </div>
</div> -->
            ...
            <div class="trend-product-wrap">
                <div class="container-fluid p-0">
                    <div class="product-img-position">
                        <img src="assets/images/product/trend.png" alt="">
                    </div>
                    <div class="row gx-0">
                        <div class="offset-lg-6 col-lg-6">
                            <div class="trend-product-content">
                                ...
                                <div class="btn-style" data-aos="fade-up" data-aos-delay="400">
                                    <a class="btn btn-outline-primary animated" href="product-details.php">Shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="features-area section-padding-2 mt-5">
            <div class="container">
                    ...
                    <div class="row mb-n6">
                        ...
                        <div class="col-lg-4 col-md-4 mb-6">
                            <div class="features-wrap text-center" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <h3>Delivery to Your Footstep</h3>
                                <p>Suspendisse sit amet accumsan massa, et ullamcorper purus</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="product-area section-padding-lr-1 section-padding-3">
            <div class="container-fluid">
                <div class="section-title mb-12 text-center">
                    <h2 data-aos="fade-up" data-aos-delay="200">Our Collection</h2>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                <div class="product-wrap">
                    <div class="product-img img-zoom mb-4">
                        <a href="product-details.php?pid=<?php echo $row1['pro_id']; ?>">
    ...
    <button type="submit" title="Wishlist">
        <img class="injectable" src="assets/images/icon-img/heart.svg" alt="">
                    ...
                    <div class="product-content text-center">
                        <h3><a href="product-details.php?pid=<?php echo $row1['pro_id']; ?>"><?php echo $row1['pro_name']; ?></a></h3>
...
<div id="pro-3" class="tab-pane">
    <div class="row mb-n10">
        ...
        while ($row2 = mysqli_fetch_array($result2)) {
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                <div class="product-wrap">
                    <div class="product-img img-zoom mb-4">
                        <a href="product-details.php?pid=<?php echo $row2['pro_id']; ?>">
    ...
    <button type="submit" title="Wishlist">
        <img class="injectable" src="assets/images/icon-img/heart.svg" alt="">
                    ...
                    <div class="product-content text-center">
                        <h3><a href="product-details.php?pid=<?php echo $row2['pro_id']; ?>"><?php echo $row2['pro_name']; ?></a></h3>
                        <div class="product-price">
...
<div id="pro-4" class="tab-pane">
    <div class="row mb-n10">
        ...
        while ($row3 = mysqli_fetch_array($result3)) {
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                <div class="product-wrap">
                    <div class="product-img img-zoom mb-4">
                        <a href="product-details.php?pid=<?php echo $row3['pro_id']; ?>">
    ...
    <button type="submit" title="Wishlist">
        <img class="injectable" src="assets/images/icon-img/heart.svg" alt="">
                    ...
                    <div class="product-content text-center">
                        <h3><a href="product-details.php?pid=<?php echo $row3['pro_id']; ?>"><?php echo $row3['pro_name']; ?></a></h3>
                        <div class="product-price">
...
<div id="pro-5" class="tab-pane">
    <div class="row mb-n10">
        ...
        while ($row4 = mysqli_fetch_array($result4)) {
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                <div class="product-wrap">
                    <div class="product-img img-zoom mb-4">
                        <a href="product-details.php?pid=<?php echo $row4['pro_id']; ?>">
                            <img class="default-img" src="admin/images/<?php echo $row4['pro_img']; ?>" alt="" style="width: 100%; height: 500px; object-fit: cover;">
                        </a>
                        <div class="product-action-wrap">
    ...
    <button type="submit" title="Wishlist">
        <img class="injectable" src="assets/images/icon-img/heart.svg" alt="">
                    ...
                    <div class="product-content text-center">
                        <h3><a href="product-details.php?pid=<?php echo $row4['pro_id']; ?>"><?php echo $row4['pro_name']; ?></a></h3>
                        <div class="product-price">
    ...
    <div class="container-fluid">
        <div class="brand-logo-active">
            ...
            <!-- <div class="brand-logo-plr-1" data-aos="fade-up" data-aos-delay="600">
                <div class="single-brand-logo">
                    <img src="//rentitonline.pk/cdn/shop/files/17_360x.png?v=1614854977" alt="Sabyasachi">
                </div>
            </div> -->
